...
insert into team_players (team_id, player_id, season_id, jersey_number, position) values
  ...
  -- Net Results (Sakic, Forsberg, Hejduk, Tanguay, Drury forwards; Blake, Foote, Bourque defense)
  ...
  ('10000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000406', '00000000-0000-0000-0000-000000000001', 40, 'forward'),
